...
import './Home.css'; // Changed CSS file to match new component name
...
const Income = () => {
    ...
    const [to, setTo] = useState('Sinar Robusta'); // Set default value to "Sinar Robusta"
    ...
    const handleSave = async () => {
        const transactionData = {
            ...
            category: "money received" // Adding the category here
        };
